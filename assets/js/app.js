...
window.onload = function(){
  ...
  function drawEverything(){
    drawRect(0, 0, W, H, '#de5003');
    drawNet();
    drawRect(0, paddle1Y, PADDLE_THICKNESS, PADDLE_HEIGHT, 'black');
    drawRect(W-PADDLE_THICKNESS, paddle2Y, PADDLE_THICKNESS, PADDLE_HEIGHT, 'black');
